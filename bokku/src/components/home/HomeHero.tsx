...
const HomeHero = () => {
  ...
  return (
    <section className="relative w-full max-w-[1920px] mx-auto overflow-hidden px-4 pt-4 md:px-8 lg:px-12">
      <div className="relative h-[65vh] min-h-[500px] w-full overflow-hidden rounded-[2rem] shadow-2xl">
        {/* Slides */}
          ...
          return (
            ...
            >
              <img
                ...
                alt={slide.alt}
                className="h-full w-full object-cover transition-transform duration-[8000ms] ease-out scale-105 hover:scale-110"
              />
              ...
              {/* Text Content */}
              <div className={`absolute bottom-0 left-0 w-full p-8 md:p-16 lg:w-2/3 transition-all duration-700 delay-300 ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
